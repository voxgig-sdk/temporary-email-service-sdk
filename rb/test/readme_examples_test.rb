...
#      offline in seeded test mode (TemporaryEmailServiceSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "TemporaryEmailService_sdk.rb")
  SDK_CLASS = "TemporaryEmailServiceSDK"
  ...
  SDK_BASE = "TemporaryEmailService_sdk"
