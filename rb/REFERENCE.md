# TemporaryEmailService Ruby SDK Reference

Complete API reference for the TemporaryEmailService Ruby SDK.
...
#### `TemporaryEmailServiceSDK.test(testopts = nil, sdkopts = nil)`
