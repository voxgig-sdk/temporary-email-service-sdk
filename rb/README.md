...
The Ruby SDK for the TemporaryEmailService API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.TemporaryEmailService(nil).load(
  { "id" => "test01" }, nil
)
