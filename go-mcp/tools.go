...
func registerTools(server *mcp.Server, client *sdk.TemporaryEmailServiceSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "temporary-email-service_list",
		Description: "List records from TemporaryEmailService. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "temporary-email-service_load",
		Description: "Load a single record from TemporaryEmailService. " +
...
func runOp(client *sdk.TemporaryEmailServiceSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TemporaryEmailServiceSDK, name string) (sdk.TemporaryEmailServiceEntity, error) {
