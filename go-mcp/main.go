// Command TemporaryEmailService-mcp is an MCP server exposing the TemporaryEmailService
// SDK as MCP tools.
//
// Two tools are registered:
//
//	TemporaryEmailService_list  — list records of an entity
//	TemporaryEmailService_load  — load a single record of an entity
//
