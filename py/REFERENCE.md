# TemporaryEmailService Python SDK Reference

Complete API reference for the TemporaryEmailService Python SDK.
...
#### `TemporaryEmailServiceSDK.test(testopts=None, sdkopts=None)`
...
```python
result = client.TemporaryEmail().load({"apikey": "apikey"})
```
