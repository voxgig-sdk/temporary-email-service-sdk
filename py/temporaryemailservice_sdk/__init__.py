...
from temporaryemailservice_sdk.utility import register

# Load features
from temporaryemailservice_sdk.feature.base_feature import TemporaryEmailServiceBaseFeature
from temporaryemailservice_sdk.features import _has_feature, _make_feature
...
class TemporaryEmailServiceSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = TemporaryEmailServiceUtility()
        self._utility = utility

        from temporaryemailservice_sdk.config import shared_config
    ...
    def get_utility(self):
        return TemporaryEmailServiceUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TemporaryEmailServiceSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def TemporaryEmail(self, data=None) -> "TemporaryEmailEntity":
        ...
        from temporaryemailservice_sdk.entity.temporary_email_entity import TemporaryEmailEntity
