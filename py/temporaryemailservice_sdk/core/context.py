...
from temporaryemailservice_sdk.core.control import TemporaryEmailServiceControl
...
from temporaryemailservice_sdk.core.helpers import get_ctx_prop, to_map
...
class TemporaryEmailServiceContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = TemporaryEmailServiceControl()
        ...
        if isinstance(sp, TemporaryEmailServiceSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TemporaryEmailServiceResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TemporaryEmailServiceResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return TemporaryEmailServiceOperation({})
    ...
    def make_error(self, code, msg):
        return TemporaryEmailServiceError(code, msg, self)
