# TemporaryEmailService Python SDK



The Python SDK for the TemporaryEmailService API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/temporary-email-service-sdk/releases)) or
...
```
py/
├── temporaryemailservice_sdk.py         -- Main SDK module
