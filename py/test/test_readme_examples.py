# TemporaryEmailService SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TemporaryEmailServiceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TemporaryEmailServiceSDK(...) and TemporaryEmailServiceSDK.test(...) become
#      TemporaryEmailServiceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "temporaryemailservice_sdk"
_SDK_CLASS = "TemporaryEmailServiceSDK"
