...
// TemporaryEmailService SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TemporaryEmailServiceSDK::test)
...
{
    private const SDK_CLASS = 'TemporaryEmailServiceSDK';
    ...
    private const SDK_BASE = 'temporaryemailservice_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../temporaryemailservice_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
