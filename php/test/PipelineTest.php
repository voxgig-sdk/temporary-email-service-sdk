...
// TemporaryEmailService SDK pipeline test
//
...
{
    private static function utility(): TemporaryEmailServiceUtility
    {
        return new TemporaryEmailServiceUtility();
    }
    ...
    private static function ctx(array $over = []): TemporaryEmailServiceContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new TemporaryEmailServiceContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new TemporaryEmailServiceOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof TemporaryEmailServiceError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new TemporaryEmailServiceOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = TemporaryEmailServiceMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new TemporaryEmailServiceOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = TemporaryEmailServiceMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new TemporaryEmailServiceOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = TemporaryEmailServiceMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TemporaryEmailServiceSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = TemporaryEmailServiceMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new TemporaryEmailServiceResponse([]),
            'result' => new TemporaryEmailServiceResult([]),
        ]);
        [, $err] = TemporaryEmailServiceMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new TemporaryEmailServiceSpec([]),
            'response' => null,
            'result' => new TemporaryEmailServiceResult([]),
        ]);
        [, $err] = TemporaryEmailServiceMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new TemporaryEmailServiceSpec(['step' => 's']),
            'response' => new TemporaryEmailServiceResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new TemporaryEmailServiceResult([]),
        ]);
        [, $err] = TemporaryEmailServiceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new TemporaryEmailServiceSpec(['step' => 's']),
            'response' => new TemporaryEmailServiceResponse(self::resp(200, ['v' => 1])),
            'result' => new TemporaryEmailServiceResult([]),
        ]);
        [, $err] = TemporaryEmailServiceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new TemporaryEmailServiceSpec(['step' => 's']),
            'response' => new TemporaryEmailServiceResponse(self::resp(200, ['v' => 2])),
            'result' => new TemporaryEmailServiceResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        TemporaryEmailServiceMakeResponse::call($ctx);
    ...
    {
        $preset = new TemporaryEmailServiceResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new TemporaryEmailServiceSpec([]),
            'response' => new TemporaryEmailServiceResponse([]),
            'result' => new TemporaryEmailServiceResult([]),
        ...
        [$got, $err] = TemporaryEmailServiceMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new TemporaryEmailServiceResult([])]);
        [, $err] = TemporaryEmailServiceMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new TemporaryEmailServiceSpec([]), 'result' => null]);
        [, $err] = TemporaryEmailServiceMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TemporaryEmailServiceSpec(['step' => 's']),
            'result' => new TemporaryEmailServiceResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new TemporaryEmailServiceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TemporaryEmailServiceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TemporaryEmailServiceSpec(['step' => 's']),
            'result' => new TemporaryEmailServiceResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new TemporaryEmailServiceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TemporaryEmailServiceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TemporaryEmailServiceResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new TemporaryEmailServiceSpec([]),
            'result' => new TemporaryEmailServiceResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = TemporaryEmailServiceMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TemporaryEmailServiceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new TemporaryEmailServiceError('boom', 'boom');
        $utility->fetcher = function (TemporaryEmailServiceContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TemporaryEmailServiceSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = TemporaryEmailServiceMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (TemporaryEmailServiceContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = TemporaryEmailServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(TemporaryEmailServiceResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        TemporaryEmailServiceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (TemporaryEmailServiceContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TemporaryEmailServiceSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = TemporaryEmailServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new TemporaryEmailServiceResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new TemporaryEmailServiceSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = TemporaryEmailServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = TemporaryEmailServiceMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = TemporaryEmailServiceMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new TemporaryEmailServiceResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, TemporaryEmailServiceDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new TemporaryEmailServiceResult(['ok' => false])]);
        $this->expectException(TemporaryEmailServiceError::class);
        TemporaryEmailServiceDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new TemporaryEmailServiceResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', TemporaryEmailServiceMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        TemporaryEmailServiceMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new TemporaryEmailServiceBaseFeature();
        $b = new TemporaryEmailServiceBaseFeature();
        TemporaryEmailServiceFeatureAdd::call($ctx, $a);
        TemporaryEmailServiceFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): TemporaryEmailServiceBaseFeature
    {
        $f = new TemporaryEmailServiceBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        TemporaryEmailServiceFeatureAdd::call($ctx, self::named_feature('a'));
        TemporaryEmailServiceFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        TemporaryEmailServiceFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        TemporaryEmailServiceFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        TemporaryEmailServiceFeatureAdd::call($ctx, $replace);
        ...
        TemporaryEmailServiceFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): TemporaryEmailServiceContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new TemporaryEmailServiceSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TemporaryEmailServicePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        TemporaryEmailServicePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new TemporaryEmailServiceResponse(['headers' => null]),
            'result' => new TemporaryEmailServiceResult([]),
        ]);
        TemporaryEmailServiceResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        TemporaryEmailServiceResultBody::call($ctx);
