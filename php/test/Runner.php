...
class TemporaryEmailServiceTestRunner
{
    ...
    {
        $live = self::getenv('TEMPORARYEMAILSERVICE_TEST_LIVE');
        $override = self::getenv('TEMPORARYEMAILSERVICE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TEMPORARYEMAILSERVICE_TEST_EXPLAIN');
