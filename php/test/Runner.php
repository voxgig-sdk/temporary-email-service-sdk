...
class TemporaryEmailServiceTestRunner
{
    ...
    {
        $live = self::getenv('TEMPORARY_EMAIL_SERVICE_TEST_LIVE');
        $override = self::getenv('TEMPORARY_EMAIL_SERVICE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TEMPORARY_EMAIL_SERVICE_TEST_EXPLAIN');
...
class_alias('TemporaryEmailServiceTestRunner', 'Runner');
class_alias('TemporaryEmailServiceHelpers', 'Helpers');
