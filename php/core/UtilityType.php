...
// TemporaryEmailService SDK utility type

class TemporaryEmailServiceUtility
{
    ...
    public static function copy(TemporaryEmailServiceUtility $src): TemporaryEmailServiceUtility
    {
        $u = new TemporaryEmailServiceUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
