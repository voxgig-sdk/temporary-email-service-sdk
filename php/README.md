...
The PHP SDK for the TemporaryEmailService API. Provides an entity-oriented interface using PHP conventions.
...
[$result, $err] = $client->TemporaryEmailService(null)->load(
    ["id" => "test01"], null
);
