# TemporaryEmailService PHP SDK Reference

Complete API reference for the TemporaryEmailService PHP SDK.
...
#### `TemporaryEmailServiceSDK::test($testopts = null, $sdkopts = null)`
