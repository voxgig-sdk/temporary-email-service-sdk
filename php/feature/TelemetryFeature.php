...
// TemporaryEmailService SDK telemetry feature
...
class TemporaryEmailServiceTelemetryFeature extends TemporaryEmailServiceBaseFeature
{
    ...
    private function _close(TemporaryEmailServiceContext $ctx, bool $ok): void
    {
