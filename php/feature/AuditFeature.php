...
// TemporaryEmailService SDK audit feature
...
class TemporaryEmailServiceAuditFeature extends TemporaryEmailServiceBaseFeature
{
    ...
    private function _emit(TemporaryEmailServiceContext $ctx, string $outcome): void
    {
