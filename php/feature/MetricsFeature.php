...
// TemporaryEmailService SDK metrics feature
...
class TemporaryEmailServiceMetricsFeature extends TemporaryEmailServiceBaseFeature
{
    ...
    private function _record(TemporaryEmailServiceContext $ctx, bool $ok): void
    {
