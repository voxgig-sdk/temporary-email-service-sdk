...
// TemporaryEmailService SDK timeout feature
...
class TemporaryEmailServiceTimeoutFeature extends TemporaryEmailServiceBaseFeature
{
    ...
    private function _with_timeout(TemporaryEmailServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TemporaryEmailServiceContext $_ctx, float $ms): void
    {
        $client = $this->client;
