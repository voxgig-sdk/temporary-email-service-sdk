...
// TemporaryEmailService SDK clienttrack feature
...
class TemporaryEmailServiceClienttrackFeature extends TemporaryEmailServiceBaseFeature
{
    ...
    public function PostConstruct(TemporaryEmailServiceContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TemporaryEmailService-SDK';
