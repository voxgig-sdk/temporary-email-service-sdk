...
describe('exists', async () => {
  ...
  //
  // TemporaryEmailServiceSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof TemporaryEmailServiceSDK, true,
      'TemporaryEmailServiceSDK.test() must return a client synchronously')
  })
