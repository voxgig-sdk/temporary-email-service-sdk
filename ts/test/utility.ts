...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.TEMPORARY_EMAIL_SERVICE_TEST_LIVE ||
    'TRUE' === process.env.TEMPORARY_EMAIL_SERVICE_TEST_OVERRIDE
  ) {
  ...
  m.TEMPORARY_EMAIL_SERVICE_TEST_EXPLAIN = process.env.TEMPORARY_EMAIL_SERVICE_TEST_EXPLAIN || m.TEMPORARY_EMAIL_SERVICE_TEST_EXPLAIN
