# TemporaryEmailService SDK feature corpus test
#
...
def _client(kase):
    ...
    TemporaryEmailServiceSDK(...), not TemporaryEmailServiceSDK.test(...): the `test` feature is
    ...
    return TemporaryEmailServiceSDK(opts)
