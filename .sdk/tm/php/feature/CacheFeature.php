...
// TemporaryEmailService SDK cache feature
...
class TemporaryEmailServiceCacheFeature extends TemporaryEmailServiceBaseFeature
{
    ...
    private function _through(TemporaryEmailServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
