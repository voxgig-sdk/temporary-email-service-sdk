...
// TemporaryEmailService SDK ratelimit feature
...
class TemporaryEmailServiceRatelimitFeature extends TemporaryEmailServiceBaseFeature
{
    ...
    private function _acquire(TemporaryEmailServiceContext $ctx): void
    {
    ...
    private function _track(TemporaryEmailServiceContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
