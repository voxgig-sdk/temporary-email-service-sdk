...
// TemporaryEmailService SDK netsim feature
...
class TemporaryEmailServiceNetsimFeature extends TemporaryEmailServiceBaseFeature
{
    ...
    private function _simulate(TemporaryEmailServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TemporaryEmailServiceContext $ctx, array $applied): void
    {
        $client = $this->client;
