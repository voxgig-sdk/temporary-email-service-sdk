...
// TemporaryEmailService SDK rbac feature
...
class TemporaryEmailServiceRbacFeature extends TemporaryEmailServiceBaseFeature
{
    ...
    private function _required(TemporaryEmailServiceContext $ctx): ?string
    {
    ...
    private function _reject(TemporaryEmailServiceContext $ctx, string $required): void
    {
    ...
    private function _track(TemporaryEmailServiceContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
