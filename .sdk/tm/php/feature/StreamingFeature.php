...
// TemporaryEmailService SDK streaming feature
...
class TemporaryEmailServiceStreamingFeature extends TemporaryEmailServiceBaseFeature
{
    ...
    private function _iterate(TemporaryEmailServiceResult $result): \Generator
    {
    ...
    private function _streamable(TemporaryEmailServiceContext $ctx): bool
    {
