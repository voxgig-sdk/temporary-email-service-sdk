...
// TemporaryEmailService SDK proxy feature
...
class TemporaryEmailServiceProxyFeature extends TemporaryEmailServiceBaseFeature
{
    ...
    public function init(TemporaryEmailServiceContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TemporaryEmailServiceContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
