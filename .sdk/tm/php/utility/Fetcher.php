...
// TemporaryEmailService SDK utility: fetcher

class TemporaryEmailServiceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TemporaryEmailServiceSDK/1.0)';
    ...
    public static function call(TemporaryEmailServiceContext $ctx, string $fullurl, array $fetchdef): array
    {
