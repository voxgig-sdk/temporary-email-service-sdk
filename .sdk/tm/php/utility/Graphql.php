...
// TemporaryEmailService SDK utility: graphql
//
...
class TemporaryEmailServiceGraphql
{
    ...
    // equivalent.
    public static function body(TemporaryEmailServiceContext $ctx): mixed
    {
    ...
    public static function errors(TemporaryEmailServiceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
