...
// TemporaryEmailService SDK utility: prepare_method

class TemporaryEmailServicePrepareMethod
{
    ...
    public static function call(TemporaryEmailServiceContext $ctx): string
    {
