...
func temporary_emailBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("TEMPORARY_EMAIL_SERVICE_TEST_TEMPORARY_EMAIL_ENTID")
	...
	idmapResolved := core.ToMapAny(env["TEMPORARY_EMAIL_SERVICE_TEST_TEMPORARY_EMAIL_ENTID"])
