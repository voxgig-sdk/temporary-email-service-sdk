...
func registerSDKWords(r *eng.Registry, client *sdk.TemporaryEmailServiceSDK) {
...
func runOp(client *sdk.TemporaryEmailServiceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
