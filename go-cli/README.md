...
AQL-driven CLI and REPL for the TemporaryEmailService SDK. Positional arguments are
...
```sh
go build -o temporary-email-service-cli ./...
```
...
./temporary-email-service-cli list temporary_email
./temporary-email-service-cli load 1 temporary_email
./temporary-email-service-cli load '{id:1}' temporary_email
