# TemporaryEmailService Lua SDK Reference

Complete API reference for the TemporaryEmailService Lua SDK.
...
```lua
local result, err = client:TemporaryEmail():load({ apikey = "apikey" })
```
