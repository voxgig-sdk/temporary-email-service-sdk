...
describe("TemporaryEmailEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set TEMPORARYEMAILSERVICE_TEST_TEMPORARY_EMAIL_ENTID JSON to run live")
      return
    end
...
function temporary_email_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("TEMPORARYEMAILSERVICE_TEST_TEMPORARY_EMAIL_ENTID")
  ...
  if env["TEMPORARYEMAILSERVICE_TEST_LIVE"] == "TRUE" then
